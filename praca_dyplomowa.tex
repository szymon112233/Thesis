...
\begin{figure}[!htbp]
	\begin{center}
\centering
\includegraphics[scale=0.3]{\ImgPath/rys/game_elements.png}
\end{center}
...
\bibitem{FilmDokumentGry1} {Ten dokument od Canal plus o twórców światów [kiedy]}
\bibitem{wiki_gameshistory} {Wiki page \url{https://pl.wikipedia.org/wiki/Historia_gier_komputerowych} [kiedy]} 
